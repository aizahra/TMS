    ...
    <title>View Destination</title>
     <style>
        ...
        .places-container {
            display: flex; 
            flex-wrap: wrap;
            justify-content: center; /* Aligning the destination panels to the center */
        }
        .place-section {
            width: 50%; 
...
<section>    
    <div class="container">
        <form action="viewPackage.jsp" method="post" enctype="multipart/form-data"> 
    <%
        ResultSet rs=null; 
    ...
    %>
        <div class="places-container">
            <div class="place-section">
                ...
                <a href="viewPackage.jsp"><button class="tour-button">Available Tours</button></a>
            </div>
        </div>
    <%
            }  

...
//
//            String path = "C:\\Users\\Sejal\\OneDrive\\Documents\\NetBeansProjects\\WebApplication2\\web" + File.separator + SAVE_DIR;
//
        ...
        if (request.getParameter("btn_delete") != null) {
            ...
            try {
               ...
               File file = new File(path + File.separator + fileName);
                ...
                Class.forName("org.apache.derby.jdbc.ClientDriver");
                Connection conn = DriverManager.getConnection("jdbc:derby://localhost:1527/tms", "tms", "tms");
                String query = "delete from signn where email=?";
        ...
        if (request.getParameter("btn_view") != null) {
            ...
            try {
                ...
                if (request.getParameter("btn_view") != null) {
                    ...
                    ResultSet rs = stmt1.executeQuery("select * from signn");

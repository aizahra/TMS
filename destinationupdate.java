...
@WebServlet("/destinationupdate")
@MultipartConfig(fileSizeThreshold=1024*1024*2, // 2MB
             maxFileSize=1024*1024*10,      // 10MB
             maxRequestSize=1024*1024*50)
public class destinationupdate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("btn_add") != null) {
            ...
            try {
                ...
                pst.setString(3, request.getParameter("txt_dname"));
                pst.setString(4, request.getParameter("txt_ddesc"));
        ...
        if (request.getParameter("btn_delete") != null) {
            ...
            try {
                ...
                Class.forName("org.apache.derby.jdbc.ClientDriver");
                Connection conn = DriverManager.getConnection("jdbc:derby://localhost:1527/tms", "tms", "tms");
                String query = "delete from destination where dname=?";

                PreparedStatement pst = conn.prepareStatement(query);
                pst.setString(1, request.getParameter("txt_dname"));
        ...
        if (request.getParameter("btn_view") != null) {
            ...
            try {
                ...
                if (request.getParameter("btn_view") != null) {
                    ...
                    ResultSet rs = stmt1.executeQuery("select * from destination");
